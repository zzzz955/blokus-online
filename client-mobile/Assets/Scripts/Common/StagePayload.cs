...
namespace BlokusUnity.Common
{
    ...
    public sealed class StagePayload
    {
        ...
        /// 장애물 데이터 파싱
        /// </summary>
        private List<Position> ParseObstacles(ApiObstacle[] obstacles)
        {
            ...
            {
                result.Add(new Position(obstacle.row, obstacle.col));
            }
            return result;
        }
        ...
        /// 사전 배치된 블록 데이터 파싱
        /// </summary>
        private List<BlockPlacement> ParsePreplacedBlocks(ApiPreplacedBlock[] preplaced)
        {
